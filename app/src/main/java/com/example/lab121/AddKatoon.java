...
public class AddKatoon extends AppCompatActivity {

    String Storage_Path = "katoons_images/";
    String Database_Path = "katoons";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new android.app.ProgressDialog(AddKatoon.this);
    ...
    */
    public void uploadFile() {
        ...
        if (filePath != null) {
            ...
            final StorageReference sRef = storageReference.child(Constands.STORAGE_PATH_UPLOADS + System.currentTimeMillis() + "." + getFileExtension(filePath));
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            sRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri downloadPhotoUrl) {
                                    Katoon katoon = new Katoon(edName.getText().toString().trim(),
                                            Integer.parseInt(edPrice.getText().toString().trim()),
                                            downloadPhotoUrl.toString());

                                    //adding an upload to firebase database
                                    String uploadId = mDatabase.push().getKey();
                                    mDatabase.child(uploadId).setValue(katoon);
                                }
                            });
            ...
            Toast.makeText(AddKatoon.this, "Please Select Image or Add Image Name", Toast.LENGTH_LONG).show();
        }
    }
